...
Template mode allows you to create a new project using an existing project's configuration as a template. This is particularly useful when you have project configuration files already checked into version control and want to ensure consistent configuration across team members. The template project's configuration file (`.claudesync/existing-project.project.json`) will be used as a base for the new project's configuration.
